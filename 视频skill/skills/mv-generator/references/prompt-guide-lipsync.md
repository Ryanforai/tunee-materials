...
#### wan_video_2_6 — 允许 1 个连续主运镜 + 时长硬约束

- 运镜规则同 kling_avatar_2_0
- **时长硬约束：每个 shot 时长必须 ∈ {5, 10, 15} 秒**
- multiple_scenes 时最后一个 shot 不能是 5 秒
...
#### kling_avatar_2_0 / wan_video_2_6
```
...
□ kling_avatar / wan_video → 每 shot 最多 1 个连续主运镜
□ wan_video → 每 shot 时长 ∈ {5, 10, 15}，末 shot ≠ 5s
