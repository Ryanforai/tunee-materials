...
├── Tunee Skill库/       ← Codex Skill 合集（图片/音乐生成）
...
输出均为**纯 JSON**。详细说明见 [`creative_analysis/AGENTS.md`](creative_analysis/AGENTS.md)。

---

### Tunee Skill库 — Codex Skill 合集

可直接安装到 Codex 的 Skill 包。
...
详细说明见 [`Tunee Skill库/AGENTS.md`](Tunee%20Skill库/AGENTS.md)。
...
详细说明见 [`视频skill/AGENTS.md`](视频skill/AGENTS.md)。
...
详细说明见 [`视频测试/AGENTS.md`](视频测试/AGENTS.md)。
...
| 模块 | 详细文档 |
|------|---------|
| 剧本大纲节点 | [`creative_analysis/AGENTS.md`](creative_analysis/AGENTS.md) |
| Tunee Skill 库 | [`Tunee Skill库/AGENTS.md`](Tunee%20Skill库/AGENTS.md) |
| 视频 Skill | [`视频skill/AGENTS.md`](视频skill/AGENTS.md) |
| 视频测试 | [`视频测试/AGENTS.md`](视频测试/AGENTS.md) |
